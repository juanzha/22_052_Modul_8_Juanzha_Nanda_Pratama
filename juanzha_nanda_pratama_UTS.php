    ...
    <div class="row">
      ...
      <div class="col">
        <div class="card " >
            ...
            <div class="p">
              ...
              <form class="d-flex" role="search" style="float: right;margin-top: 10px;" action="juanzha_nanda_pratama_UTS.php">
                <input class="form-control me-2" type="text" placeholder="Cari Berdasarkan NIM" aria-label="Search" style="background-color: rgb(228, 225, 225);" name="cari" value="<?php if(isset($_GET['cari'])){echo $_GET['cari'];}?>">
      ...
              </form>
            ...
            <table class="table table-striped table-hover" border="1px" >
                ...
                if(isset($_GET['cari'])){
                  $pencarian =$_GET['cari'];
                  $query="SELECT*FROM tbl_mhs2 WHERE nim LIKE '%".$pencarian."%' OR  nama_mhs LIKE '%".$pencarian."%' OR  nama_dosen LIKE '%".$pencarian."%' OR  st LIKE '%".$pencarian."%' OR  ket LIKE '%".$pencarian."%'";
                }
                else{
                  $query = "SELECT*FROM tbl_mhs2 ORDER BY nim ";
                }
